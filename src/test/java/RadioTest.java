...
public class RadioTest {
    ...
    public void checkPrevStation3() {
        ...
        radio7.setRadioStation(0);
        radio7.prevStation();

        int expected = 9;
        int actual = radio7.getRadioStation();
    ...
    public void checkSetRadioStation6() {
        ...
        radio6.setRadioStation(11);
        int expected = 0;
        int actual = radio6.getRadioStation();
